...
{
    public partial class frmMain2020 : Form
    {
        ...
        public string[] NewLayersName = { "CSKFBJ", "HHSM", "KCDMB", "QTJSYDQ", "TDYTQ", "JSYDHJBNTGZ" };
        public string[] ChineseLayerName = { "城市开发边界", "规划河湖水面", "行政区划扩充代码表", "其他建设用地区", "土地用途区", "建设用地和基本农田管制" };
        ...
        private void btnAttributeCheck_Click(object sender, Janus.Windows.Ribbon.CommandEventArgs e)
        {
            ...
            ILayer layerresult = GetLayerByName("KCDMB");
            if (layerresult != null)
            {
                CheckTextAttribute(layerresult, "XZQDM", null, 12);
                CheckTextAttribute(layerresult, "XZQMC", null, 100);
                this.Invoke(myDelegateUpdateUiStatus, new object[] { "图层KCDMB属性检查完成" });
            }
            ...
            layerresult = GetLayerByName("HHSM");
            if (layerresult != null)
            {
                CheckAttributeBSM(layerresult);
                CheckTextAttribute(layerresult, "HHMC", null, 30);
                CheckAttributeMJ(layerresult, "TBMJ");
                this.Invoke(myDelegateUpdateUiStatus, new object[] { "图层HHSM属性检查完成" });
            }
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });

            layerresult = GetLayerByName("QTJSYDQ");
            if (layerresult != null)
            {
                CheckAttributeBSM(layerresult);
                CheckTextAttribute(layerresult, "TZLX",new string[] {"上轮规划保留","调整完善增加"}, 10);
                CheckTextAttribute(layerresult, "GHYDLX", new string[] { "现状保留", "规划新增" }, 10);
                CheckTextAttribute(layerresult, "GHYJ", null, 100);
                CheckAttributeMJ(layerresult, "TBMJ");
                this.Invoke(myDelegateUpdateUiStatus, new object[] { "图层QTJSYDQ属性检查完成" });
            }
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });

            layerresult = GetLayerByName("TDYTQ");
            if (layerresult != null)
            {
                CheckAttributeBSM(layerresult);
                CheckTextAttribute(layerresult, "XZQDM", null, 12);
                CheckTextAttribute(layerresult, "TDYTFLDM", new string[] {"010","020","030","110","120","130",
                "140","210"}, 3);
                CheckTextAttribute(layerresult, "TDYTFLMC", new string[] { "城镇建设用地区", "其他建设用地区", "交通用地", "基本农田", "一般农用地", "减量化建设用地",
                "河湖水面","生态环境安全控制区"}, 10);
                CheckAttributeMJ(layerresult, "TDYTQMJ");
                CheckAttributeMSorSM(layerresult, "SM");
                this.Invoke(myDelegateUpdateUiStatus, new object[] { "图层TDYTQ属性检查完成" });
            }
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });

            layerresult = GetLayerByName("JSYDHJBNTGZ");
            if (layerresult != null)
            {
                CheckAttributeBSM(layerresult);
                CheckTextAttribute(layerresult, "XZQDM", null, 12);
                CheckTextAttribute(layerresult, "GZLXDM", new string[] {"010","030","040"}, 10);
                CheckTextAttribute(layerresult, "GZLXMC", new string[] { "允许建设区", "限制建设区", "禁止建设区" }, 20);
                CheckAttributeMJ(layerresult, "MJ");
                this.Invoke(myDelegateUpdateUiStatus, new object[] { "图层JSYDHJBNTGZ属性检查完成" });
            }
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateUpdateBarValue, new object[] { 0 });
        ...
        private void btnTopologyCheck_Click(object sender, Janus.Windows.Ribbon.CommandEventArgs e)
        {
            ...
            string HHSM = "HHSM";
            string KCDMB = "KCDMB";
            string QTJSYDQ = "QTJSYDQ";
            string TDYTQ = "TDYTQ";
            string JSYDHJBNTGZ = "JSYDHJBNTGZ";
            this.Invoke(myDelegateAppendTextInfo, new object[] { CT.CheckSelfIntersection(GetLayerByName(CSKFBJ), ref pErrorDataTable) });
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateAppendTextInfo, new object[] { CT.CheckSelfIntersection(GetLayerByName(HHSM), ref pErrorDataTable) });
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateAppendTextInfo, new object[] { CT.CheckSelfIntersection(GetLayerByName(KCDMB), ref pErrorDataTable) });
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateAppendTextInfo, new object[] { CT.CheckSelfIntersection(GetLayerByName(QTJSYDQ), ref pErrorDataTable) });
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateAppendTextInfo, new object[] { CT.CheckSelfIntersection(GetLayerByName(TDYTQ), ref pErrorDataTable) });
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateAppendTextInfo, new object[] { CT.CheckSelfIntersection(GetLayerByName(JSYDHJBNTGZ), ref pErrorDataTable) });
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateAppendTextInfo, new object[] { CT.CheckSimple(GetLayerByName(CSKFBJ), ref pErrorDataTable) });
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateAppendTextInfo, new object[] { CT.CheckSimple(GetLayerByName(HHSM), ref pErrorDataTable) });
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateAppendTextInfo, new object[] { CT.CheckSimple(GetLayerByName(KCDMB), ref pErrorDataTable) });
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateAppendTextInfo, new object[] { CT.CheckSimple(GetLayerByName(QTJSYDQ), ref pErrorDataTable) });
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateAppendTextInfo, new object[] { CT.CheckSimple(GetLayerByName(TDYTQ), ref pErrorDataTable) });
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateAppendTextInfo, new object[] { CT.CheckSimple(GetLayerByName(JSYDHJBNTGZ), ref pErrorDataTable) });
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateAppendTextInfo, new object[] { CT.CheckSelfOverlap(GetLayerByName(CSKFBJ), ref pErrorDataTable, 1) });
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateAppendTextInfo, new object[] { CT.CheckSelfOverlap(GetLayerByName(HHSM), ref pErrorDataTable, 100) });
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateAppendTextInfo, new object[] { CT.CheckSelfOverlap(GetLayerByName(KCDMB), ref pErrorDataTable, 100) });
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateAppendTextInfo, new object[] { CT.CheckSelfOverlap(GetLayerByName(QTJSYDQ), ref pErrorDataTable, 5000) });
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateAppendTextInfo, new object[] { CT.CheckSelfOverlap(GetLayerByName(TDYTQ), ref pErrorDataTable, 10000) });
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateAppendTextInfo, new object[] { CT.CheckSelfOverlap(GetLayerByName(JSYDHJBNTGZ), ref pErrorDataTable, 10000) });
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            BindingSource bind = new BindingSource();
            bind.DataSource = pErrorDataTable;
        ...
        private void buttonCommand5_Click(object sender, Janus.Windows.Ribbon.CommandEventArgs e)
        {
            ...
            this.Invoke(this.myDelegateAppendTextInfo, new object[] { AppendText });
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateAppendTextInfo, new object[] { CDC.CheckSpatialRangeEquals(GetLayerByName("TDYTQ") as IFeatureLayer, GetLayerByName("JSYDHJBNTGZ") as IFeatureLayer, ref pErrorDataTable, "TDYTQ2035", "TDYTFLDM LIKE '110'", "JSYDHJBNTGZ", "GZLXDM LIKE '030'", "RELATE(G1, G2, 'T*F*T*F**')", "6502") });
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateAppendTextInfo, new object[] { CDC.CheckSpatialRangeEquals(GetLayerByName("TDYTQ") as IFeatureLayer, GetLayerByName("JSYDHJBNTGZ") as IFeatureLayer, ref pErrorDataTable, "TDYTQ2035", "TDYTFLDM LIKE '010' OR TDYTFLDM LIKE '020' OR TDYTFLDM LIKE '030'", "JSYDHJBNTGZ", "GZLXDM LIKE '010'", "RELATE(G1, G2, 'T*F*T*F**')", "6503") });
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
        ...
        private void dgvError_RowHeaderMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            else
            {
                ...
                //根据查询条件选择要素
                if (pFeatureSelection == null) { return; }
        ...
        private void buttonCommand7_Click_1(object sender, Janus.Windows.Ribbon.CommandEventArgs e)
        {
            OpenFileDialog opfd1 = new OpenFileDialog();
            opfd1.Filter = "csv文件(*.csv)|*.csv|allfile(*.*)|*.*";
            opfd1.Multiselect = false;
            DialogResult diaLres = opfd1.ShowDialog();
            if (diaLres != DialogResult.OK)
                return;
        ...
        private void buttonCommand2_Click_1(object sender, Janus.Windows.Ribbon.CommandEventArgs e)
        {
            if (cbIsClear.Checked == true)
            {
                pErrorDataTable.Rows.Clear();
            }
            this.Invoke(myDelegateUpdateUiStatus, new object[] { "正在上下级规划指标一致性检查..." });
            this.Invoke(myDelegateAppendTextInfo, new object[] { "\r\n上下级规划指标一致性检查\r\n时间:" + DateTime.Now.ToString() });

            BindingSource bind = new BindingSource();
            bind.DataSource = pErrorDataTable;
            dgvError.DataSource = bind;
            this.Invoke(myDelegateUpdateUiStatus, new object[] { "上下级规划指标一致性完成" });
            this.Invoke(myDelegateAppendTextInfo, new object[] { "\r\n上下级规划指标一致性完成\r\n" });
        }

        private void buttonCommand3_Click_1(object sender, Janus.Windows.Ribbon.CommandEventArgs e)
        {
            if (cbIsClear.Checked == true)
            {
                pErrorDataTable.Rows.Clear();
            }
            this.Invoke(myDelegateUpdateUiStatus, new object[] { "正在表格数据检查..." });
            this.Invoke(myDelegateAppendTextInfo, new object[] { "\r\n表格数据检查\r\n时间:" + DateTime.Now.ToString() });
            progressBar1.Maximum = 8;

            TreeNode TableFileName = CDC.CallFindNode(treeView1, "ZBTZQKB");
            ITable ptable = CDC.getITable(TableFileName);
            if (ptable == null) { this.Invoke(myDelegateAppendTextInfo, new object[] { "\r\n" + "ZBTZQKB" + "不存在\r\n" });  }
            if (ptable != null)
            {
                CheckTableTextAttribute(ptable, "ZBTZQKB", "XZQDM", null, 12);
                CheckTableTextAttribute(ptable, "ZBTZQKB", "ZBDM", new string[] { "01", "02", "03", "09" }, 30);
                CheckTableTextAttribute(ptable, "ZBTZQKB", "ZBSXDM", null, 2);
                this.Invoke(myDelegateUpdateUiStatus, new object[] { "图层ZBTZQKB属性检查完成" });
            }
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateUpdateBarValue, new object[] { 0 });

            TableFileName = CDC.CallFindNode(treeView1, "ZBFJB");
            ptable = CDC.getITable(TableFileName);
            if (ptable == null) { this.Invoke(myDelegateAppendTextInfo, new object[] { "\r\n" + "ZBFJB" + "不存在\r\n" }); }
            if (ptable != null)
            {
                CheckTableTextAttribute(ptable, "ZBFJB", "XZQDM", null, 12);
                CheckTableTextAttribute(ptable, "ZBFJB", "ZBDM", new string[] { "01", "02", "03", "09" }, 10);
                CheckTableTextAttribute(ptable, "ZBFJB", "ZBSXDM", null, 2);
                this.Invoke(myDelegateUpdateUiStatus, new object[] { "图层ZBFJB属性检查完成" });
            }
            this.Invoke(myDelegateUpdateBarValue, new object[] { progressBar1.Value + 1 });
            this.Invoke(myDelegateUpdateBarValue, new object[] { 0 });
            ...
            bind.DataSource = pErrorDataTable;
            dgvError.DataSource = bind;
            this.Invoke(myDelegateUpdateUiStatus, new object[] { "表格数据检查完成" });
            this.Invoke(myDelegateAppendTextInfo, new object[] { "\r\n表格数据检查完成\r\n" });
        }
        ...
        /// <param name="TextRange">允许的text的长度</param>
        /// <param name="TextLength">允许的text的值域</param>
        private void CheckTableTextAttribute(ITable pTable,string TableName, string TextAttributeName, string[] TextRange, int TextLength)
        {
            ITable ptable = (ITable)pTable;
            int FieldIndex = ptable.FindField(TextAttributeName);
            if (FieldIndex < 0)
            {
                this.Invoke(myDelegateAppendTextInfo, new object[] { "\r\nERROR5201:" + TableName + "的属性字段" + TextAttributeName + "不存在或正名命名错误" });
                pErrorDataTable.Rows.Add(new object[] { "5201", TableName, TextAttributeName, null, TableName + "的属性字段" + TextAttributeName + "不存在或正名命名错误", false, true });
                return;
            }
            int IDIndex = ptable.FindField("OBJECTID");
            IField pfield = ptable.Fields.get_Field(FieldIndex);
            if (pfield != null)
            {
                if (esriFieldType.esriFieldTypeString != pfield.Type)
                {
                    this.Invoke(myDelegateAppendTextInfo, new object[] { "\r\nERROR5201:" + TableName + "的属性字段" + TextAttributeName + "类型不是Text" });
                    pErrorDataTable.Rows.Add(new object[] { "5201", TableName, TextAttributeName, null, TableName + "的属性字段" + TextAttributeName + "类型不是Text", false, true });
                    return;
                }
                if (pfield.Length != TextLength)
                {
                    this.Invoke(myDelegateAppendTextInfo, new object[] { "\r\nERROR5201:" + TableName + "的属性字段" + TextAttributeName + "字段长度不为" + TextLength.ToString() });
                    pErrorDataTable.Rows.Add(new object[] { "5201", TableName, TextAttributeName, null, TableName + "的属性字段" + TextAttributeName + "字段长度不为" + TextLength.ToString(), false, true });
                }
                ICursor pCursor = ptable.Search(null, false);
                IRow pRrow = pCursor.NextRow();
                while (pRrow != null)
                {
                    if (Convert.IsDBNull(pRrow.get_Value(FieldIndex)))
                    {
                        this.Invoke(myDelegateAppendTextInfo, new object[] { "\r\nERROR5601:" + TableName + "的属性字段" + TextAttributeName + " objectID=" + pRrow.get_Value(IDIndex) + "的值为空" });
                        pErrorDataTable.Rows.Add(new object[] { "5601", TableName, TextAttributeName, pRrow.get_Value(IDIndex).ToString(), TableName + "的属性字段" + TextAttributeName + " objectID=" + pRrow.get_Value(IDIndex) + "的值为空", false, true });
                    }
                    else
                    {
                        if (TextRange != null)
                        {
                            if (TextRange.Contains((string)pRrow.get_Value(FieldIndex)) == false)
                            {
                                this.Invoke(myDelegateAppendTextInfo, new object[] { "\r\nERROR5301:" + TableName + "的属性字段" + TextAttributeName + " objectID=" + pRrow.get_Value(IDIndex) + "的值不符合要求" });
                                pErrorDataTable.Rows.Add(new object[] { "5301", TableName, TextAttributeName, pRrow.get_Value(IDIndex).ToString(), TableName + "的属性字段" + TextAttributeName + " objectID=" + pRrow.get_Value(IDIndex) + "的值不符合要求", false, true });
                            }
                        }
                    }
                    pRrow = pCursor.NextRow();
        ...
        private void buttonCommand1_Click_1(object sender, Janus.Windows.Ribbon.CommandEventArgs e)
        {
            ...
            this.Invoke(myDelegateUpdateUiStatus, new object[] { "正在数据一致性检查..." });
            this.Invoke(myDelegateAppendTextInfo, new object[] { "\r\n数据一致性检查\r\n时间:" + DateTime.Now.ToString() });
            this.Invoke(myDelegateAppendTextInfo, new object[] { CDC.CheckArea(GetLayerByName("JSYDHJBNTGZ"), "GZLXDM LIKE '010'", treeView1, "ZBTZQKB", "ZBDM = '03'", "XZMJ", 0, ref pErrorDataTable, "6402") });
            this.Invoke(myDelegateAppendTextInfo, new object[] { CDC.CheckArea(GetLayerByName("TDYTQ"), "TDYTFLDM = '110'", treeView1, "ZBTZQKB", "ZBDM = '02'", "XZMJ", 0, ref pErrorDataTable, "6403") });

            BindingSource bind = new BindingSource();
            bind.DataSource = pErrorDataTable;
            dgvError.DataSource = bind;
            this.Invoke(myDelegateUpdateUiStatus, new object[] { "数据一致性检查完成" });
            this.Invoke(myDelegateAppendTextInfo, new object[] { "\r\n数据一致性检查完成\r\n" });
        }
    }
}